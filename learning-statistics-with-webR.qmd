...
# Descriptive statistics {background-color="#b4b7b8"}
...
ggplot() +
  ...
  scale_colour_gradient(low = "#d88687", high = "#7c090b") +
...
For the examples later, let's create a population of data and draw a sample from it in R:
